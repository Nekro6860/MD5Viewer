...
class Vector3
{
 ...
 public:
  ...
  // Vector negation
  Vector3<Real> operator-( void ) const;
...
class Matrix4x4
{
 ...
 public:
  ...
  Vector3<Real> getRightVector( void ) const;
  Vector3<Real> getUpVector( void ) const;
  Vector3<Real> getForwardVector( void ) const;
  Vector3<Real> getTranslation( void ) const;
...
class Quaternion
{
 ...
 public:
  ...
  Vector3<Real> getRotationAxis( void ) const;
  ...
  Quaternion<Real> operator~( void ) const; // Quaternion conjugate
  Quaternion<Real> operator-( void ) const; // Quaternion negation
