...
/////////////////////////////////////////////////////////////////////////////
//
// Mathlib.inl -- by David Henry
// last revision: june. 23, 2005
//
// -------------------------------------------------------------------
...
template <typename Real>
inline bool Vector3<Real>::isZero( void )
{
...
template <typename Real>
inline void Vector3<Real>::normalize( void )
{
...
template <typename Real>
inline Vector3<Real> Vector3<Real>::operator-( void ) const
{
...
template <typename Real>
inline Vector3<Real> &Vector3<Real>::operator*=( Real s )
{
  _x *= s; _y *= s; _z *= s;
  return *this;
}
...
template <typename Real>
inline Vector3<Real> operator*( Real k, Vector3<Real> v )
{
...
template <typename Real>
inline void Matrix4x4<Real>::identity( void )
{
...
template <typename Real>
inline void Matrix4x4<Real>::transpose( void )
{
  *this = Transpose( *this );
}
...
template <typename Real>
inline void Matrix4x4<Real>::invert( void )
{
  *this = Invert( *this );
}
...
template <typename Real>
inline void Matrix4x4<Real>::setTranslation( const Vector3<Real> &v )
{
...
template <typename Real>
inline void Matrix4x4<Real>::transform( Vector3<Real> &v ) const
{
...
template <typename Real>
inline void Matrix4x4<Real>::rotate( Vector3<Real> &v ) const
{
  v = Vector3<Real>(
...
template <typename Real>
inline void Matrix4x4<Real>::inverseRotate( Vector3<Real> &v ) const
{
  v = Vector3<Real>(
...
template <typename Real>
inline void Matrix4x4<Real>::inverseTranslate( Vector3<Real> &v ) const
{
  v._x -= _tx;
  v._y -= _ty;
  v._z -= _tz;
...
template <typename Real>
inline void Matrix4x4<Real>::fromQuaternion( const Quaternion<Real> &q )
{
...
template <typename Real>
inline void Matrix4x4<Real>::fromEulerAngles( Real x, Real y, Real z )
{
...
template <typename Real>
inline void Matrix4x4<Real>::toEulerAngles( Real &x, Real &y, Real &z ) const
{
...
// --------------------------------------------------------------------------
// Matrix4x4::getRightVector
// Matrix4x4::getUpVector
// Matrix4x4::getForwardVector
...
template <typename Real>
inline Vector3<Real> Matrix4x4<Real>::getRightVector( void ) const
{
  return Vector3<Real>( _m11, _m12, _m13 );
}

template <typename Real>
inline Vector3<Real> Matrix4x4<Real>::getUpVector( void ) const
{
  return Vector3<Real>( _m21, _m22, _m23 );
}

template <typename Real>
inline Vector3<Real> Matrix4x4<Real>::getForwardVector( void ) const
{
  return Vector3<Real>( _m31, _m32, _m33 );
}

template <typename Real>
inline Vector3<Real> Matrix4x4<Real>::getTranslation( void ) const
{
...
template <typename Real>
inline Matrix4x4<Real> RotationMatrix( Axis axis, Real theta )
{
  Matrix4x4<Real> res;
...
template <typename Real>
inline Matrix4x4<Real> RotationMatrix( const Vector3<Real> &axis, Real theta )
{
  Matrix4x4<Real> res;
...
template <typename Real>
inline Matrix4x4<Real> TranslationMatrix( Real x, Real y, Real z )
{
  return TranslationMatrix( Vector3<Real>( x, y, z ) );
}

template <typename Real>
inline Matrix4x4<Real> TranslationMatrix( const Vector3<Real> &v )
{
  Matrix4x4<Real> res;
...
template <typename Real>
inline Matrix4x4<Real> ScaleMatrix( const Vector3<Real> &s )
{
  Matrix4x4<Real> res;
...
template <typename Real>
inline Matrix4x4<Real> ScaleAlongAxisMatrix( const Vector3<Real> &axis, Real k )
{
  Matrix4x4<Real> res;
...
template <typename Real>
inline Matrix4x4<Real> ShearMatrix( Axis axis, Real s, Real t )
{
  Matrix4x4<Real> res;
...
template <typename Real>
inline Matrix4x4<Real> ProjectionMatrix( const Vector3<Real> &n )
{
  Matrix4x4<Real> res;
...
template <typename Real>
inline Matrix4x4<Real> ReflectionMatrix( Axis axis, Real k )
{
  Matrix4x4<Real> res;
...
template <typename Real>
inline Matrix4x4<Real> AxisReflectionMatrix( const Vector3<Real> &n )
{
  Matrix4x4<Real> res;
...
template <typename Real>
inline void Quaternion<Real>::identity( void )
{
  _w = 1.0; _x = _y = _z = 0.0;
}
...
template <typename Real>
inline void Quaternion<Real>::normalize( void )
{
...
template <typename Real>
inline void Quaternion<Real>::computeW( void )
{
...
//
// Rotate a point by quaternion.  v' = q * qv * inv(q), where qv = <0, v>.
// --------------------------------------------------------------------------

template <typename Real>
void Quaternion<Real>::rotate( Vector3<Real> &v ) const
{
  Quaternion<Real> qf = *this * v * Inverse( *this );
  v._x = qf._x;
  v._y = qf._y;
  v._z = qf._z;
}
...
template <typename Real>
inline void Quaternion<Real>::fromMatrix( const Matrix4x4<Real> &m )
{
...
template <typename Real>
inline void Quaternion<Real>::fromEulerAngles( Real x, Real y, Real z )
{
...
template <typename Real>
inline void Quaternion<Real>::toEulerAngles( Real &x, Real &y, Real &z ) const
{
  // Compute Y-axis angle
...
template <typename Real>
inline Real Quaternion<Real>::getRotationAngle( void ) const
{
...
template <typename Real>
inline Vector3<Real> Quaternion<Real>::getRotationAxis( void ) const
{
...
template <typename Real>
inline Quaternion<Real> Quaternion<Real>::operator+( const Quaternion<Real> &q ) const
{
...
// Quaternion concatenation.  The order of multiplication, from left
...
template <typename Real>
inline Quaternion<Real> Quaternion<Real>::operator*( const Vector3<Real> &v ) const
{
  // q * v = q * p where p = <0,v>
...
template <typename Real>
inline Quaternion<Real> &Quaternion<Real>::operator*=( const Vector3<Real> &v )
{
  *this = *this * v;
  return *this;
}
...
template <typename Real>
inline Quaternion<Real> Quaternion<Real>::operator*( Real k ) const
{
  return Quaternion<Real>( _w * k, _x * k, _y * k, _z * k );
}

template <typename Real>
inline Quaternion<Real> &Quaternion<Real>::operator*=( Real k )
{
  _w *= k; _x *= k; _y *= k; _z *= k;
  return *this;
}
...
template <typename Real>
inline Quaternion<Real> Quaternion<Real>::operator~( void ) const
{
...
template <typename Real>
inline Quaternion<Real> Squad( const Quaternion<Real> &q0,
